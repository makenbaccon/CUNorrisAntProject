...
;;
;;BOLD COMMENTS NEED CLARIFICATION
;;
...
[ dish-radius        ;;size of the radius around the ant hill
  dish-radius2       ;;WHAT IS THIS?
  coeff              ;;WHAT IS THIS?
  location-power1    ;;WHAT IS THIS?
  location-power2    ;;WHAT IS THIS?
  location-power3    ;;WHAT IS THIS?
  x1                 ;;WHAT IS THIS?
  y1                 ;;WHAT IS THIS?
  x2                 ;;WHAT IS THIS?
  y2                 ;;WHAT IS THIS?
...
to setup 
  ...
  set-world-size    ;;WHAT IS THIS? FUNCTION CALL?
...
to setup-ant-hill
  ...
  set dish-radius floor ( max-pxcor * 0.33)                    ;;33% of the x-direction makes th radius of the dish 
  ...
  set dish-radius2 floor ( max-pxcor * 0.4)                    ;;33% of the x-direction makes th radius of the dish 
  ask patches [ set in-dish2? false ]
  ask turtle 0 [ask patches in-radius dish-radius2 [ set in-dish2? true ]]  ;;designate inside and outside of dish
...
<experiments>
  <experiment name="experiment" repetitions="1000" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2999"/>
    <metric>count turtles</metric>
    <metric>count nest-patrollers</metric>
    <metric>count trail-patrollers</metric>
    <metric>count foragers</metric>
    <metric>count middens</metric>
    <metric>count inactives</metric>
    <enumeratedValueSet variable="scaling-factor">
      <value value="2"/>
    </enumeratedValueSet>
