...
breed [inactive-ants inactive-ant] ;;not yet designated a "job"
...
to go
  ...
  tick  
  ask turtles[ query-view]
end

to query-view
  
  if previous-status = visual-status
  [
     stop
  ]
