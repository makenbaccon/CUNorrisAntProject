...
to create-food
;  if (distancexy (0.3 * max-pxcor) 12 ) < 2
;    [ set food-source-number 1 ]
;    ;; setup food source two on the lower-left
    if (distancexy (-.85 * max-pxcor) (.8 * max-pycor)) < 2
...
to recolor-patch  ;; patch procedure
  ...
  [ if food > 0       ;; Color food
    [ if food-source-number = 1 [ set pcolor cyan ] 
      if food-source-number = 2 [ set pcolor Black  ]
...
@#$#@#$#@
<experiments>
  <experiment name="Best Wiggle" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <exitCondition>sum [food] of patches &lt; 24</exitCondition>
    <steppedValueSet variable="amount-of-wiggle" first="0" step="2" last="4"/>
    <steppedValueSet variable="population" first="2" step="2" last="6"/>
  </experiment>
  <experiment name="Best Wiggle" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <exitCondition>sum [food] of patches &lt; 18</exitCondition>
    ...
    <steppedValueSet variable="amount-of-wiggle" first="0" step="1" last="10"/>
  </experiment>
  <experiment name="Best Wiggle 2" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="amount-of-wiggle" first="2.5" step="0.5" last="6"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
