...
to create-food
  if (distancexy random-xcor random-ycor) < 10
...
<experiments>
  ...
  <experiment name="Best Wiggle" repetitions="3" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="amount-of-wiggle" first="0" step="2" last="12"/>
    <enumeratedValueSet variable="population">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Chem-Low-Threshold">
