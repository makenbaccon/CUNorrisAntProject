...
to Add-food  ;; patch procedure
  ...
  if ticks <= 2 [
    if (distancexy (0.85 * max-pxcor) 0) < 5
    ...
    ;; set "food" at sources to either 1 or 4, randomly
  ]
...
to uphill-chemical  ;; turtle procedure
  ...
  let scent-right chemical-scent-at-angle  sensitive
  let scent-left  chemical-scent-at-angle  (sensitive * -1)
...
to uphill-nest-scent  ;; turtle procedure
  ...
  let scent-right nest-scent-at-angle  sensitive
  let scent-left  nest-scent-at-angle  (sensitive * -1)
  if (scent-right > scent-ahead) or (scent-left > scent-ahead)
  [ ifelse scent-right > scent-left
    [ rt sensitive ]
    [ lt sensitive ] ]
...
to wiggle  ;; turtle procedure
  rt random amount-of-wiggle
  lt random amount-of-wiggle
  ;;if not can-move? 1 [ rt 180 ]
end
...
to add-food2
  ;;Adds food where mouse is clicked
;;  if mouse-down? [
;;    if (distancexy mouse-xcor mouse-ycor) < 5
;;  [ set food-source-number 4 ] ]
...
;; Credit to 1997 Uri Wilensky for frame or program
@#$#@#$#@
GRAPHICS-WINDOW
257
10
